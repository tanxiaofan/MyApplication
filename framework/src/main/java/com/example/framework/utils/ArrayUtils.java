 ...
 *
 * <ul>
 *   <li>{@link #isEmpty(Object[])} is null or its length is 0
 *   <li>{@link #getLast(Object[], Object, Object, boolean)} get last element of the target element,
 *       before the first one that match the target element front to back
 *   <li>{@link #getNext(Object[], Object, Object, boolean)} get next element of the target element,
 *       after the first one that match the target element front to back
 *   <li>{@link #getLast(Object[], Object, boolean)}
 *   <li>{@link #getLast(int[], int, int, boolean)}
 *   <li>{@link #getLast(long[], long, long, boolean)}
 *   <li>{@link #getNext(Object[], Object, boolean)}
 *   <li>{@link #getNext(int[], int, int, boolean)}
 *   <li>{@link #getNext(long[], long, long, boolean)}
 * </ul>
 *
...
public class ArrayUtils {
   ...
   *
   * <ul>
   *   <li>if array is empty, return defaultValue
   *   <li>if target element is not exist in array, return defaultValue
   *   <li>if target element exist in array and its index is not 0, return the last element
   *   <li>if target element exist in array and its index is 0, return the last one in array if
   *       isCircle is true, else return defaultValue
   * </ul>
   *
   * @param <V>
   * @param sourceArray
   ...
   *   <li>if array is empty, return defaultValue
   *   <li>if target element is not exist in array, return defaultValue
   *   <li>if target element exist in array and not the last one in array, return the next element
   *   <li>if target element exist in array and the last one in array, return the first one in array
   *       if isCircle is true, else return defaultValue
   * </ul>
   *
   * @param <V>
   * @param sourceArray
